...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['acao']) && $_POST['acao'] == "novo") {
    ...
    if (strlen($nome) > 0 && strlen($especialidade) > 0) {

        if (adicionarProfissional($nome, $especialidade)) {
            $msgSucesso = "Profissional cadastrado com sucesso!";
        } else {
            $msgErro = "Erro ao cadastrar profissional!";
        }
...
<div class="container">
    ...
    <!-- FORMULÁRIO DE EDIÇÃO (APARECE SOMENTE QUANDO EXISTE ?editar=id ) -->
